  ...
  try {
    ...
    const updatedVendor = await prisma.vendor.update({
      ...
      data: {
        ...
        ...(acceptsStripe !== undefined && { acceptsStripe }),
        ...(acceptsVenmo !== undefined && { acceptsVenmo }),
        ...(acceptsCashApp !== undefined && { acceptsCashApp }),
        ...(acceptsZelle !== undefined && { acceptsZelle }),
        // Payment method details
        ...(stripeAccountId !== undefined && { stripeAccountId: stripeAccountId || null }),
